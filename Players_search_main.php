...
if (isset($_POST['search']))
{
    ...
    $sql2 = "SELECT Players.P_Id,Players.P_name,Team.Team_Name,Players.Age,Players.P_Role,Players.Country,
            ...
            INNER JOIN  Individual_stats ON Players.P_Id = Individual_stats.P_Id)";
    ...
    if ($count['COUNT(*)'] === 2)
    {
        while ($row = mysqli_fetch_array($sql2_run)) {
            ...
            ?>
                ...
                <body>
                    <center><img src="https://static.iplt20.com/players/210/108.png">
                        <h1>Suryakumar Yadav</h1></center>
                        <ul>
                            <li><strong>Details</strong>
                            <table border="1">
                                <tbody>
                                    <tr>
                                        <td>Player ID</td><td><?php echo $row['P_Id'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Name</td><td><?php echo $row['P_name'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Team</td><td><?php echo $row['Team_name'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Age</td><td><?php echo $row['Age'] ?></td>
                                    </tr>
                                    <tr>
                                        <td>Role</td><td><?php echo $row['Role'] ?></td>
                                    </tr>
                                    <tr>
